package com.depositservice.controller;
...
import com.depositservice.config.SpringH2DatabaseConfig;
...
public class DepositControllerTest {
    ...
    public void createDeposit() throws Exception {
        ...
        List<Deposit> deposits = depositRepository.findDepositsByEmail("test@test.ru");
